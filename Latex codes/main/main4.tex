...
\footnotetext{
\noindent \textbf{Email:} szekely.barnabas93@gmail.com}
\footnotetext{\textbf{Institution:} Goethe-Universität, GSEFM } 
...
Creditors limit lending against future cash flows if they expect the borrower to be liquidated under financial distress. This puts small and medium-sized firms at a disadvantage since high reorganization costs often force the liquidation of these businesses. I study the general equilibrium effects of this mechanism in a heterogeneous firms model, calibrated to the U.S. economy. Limited access to cash flow-based debt experienced by small, but productive firms suppresses entry and yields significant aggregate productivity losses. These results suggest that recent policy efforts to streamline the reorganization process, such as the Small Business Reorganization Act of 2019, can raise aggregate productivity, by improving small firms' access to external finance. 
...
Under the US bankruptcy framework, the debtor is expected to file for bankruptcy - although creditors may petition the court to initiate bankruptcy proceedings against the debtor, this is not the norm. The IDB dataset documents both the original chapter under which bankruptcy was filed and the chapter under which it was ultimately resolved. In the case of Chapter 11 (reorganization) filings, 6.5\% were eventually converted to Chapter 7 (liquidation). In contrast, only 0.16\% of Chapter 7 filings were later converted to Chapter 11, reflecting the legal, and practical difficulties in overturning a liquidation decision. Although 11 U.S.C. § 706(b) allows the creditor to request a conversion from Chapter 7 to Chapter 11, if the firms' management is unwilling to continue the court is unlikely to grant the conversion of the case. Moreover, it is unrealistic for the lender to replace the original management without a significant loss of value. Hence from the lender's perspective, the borrower's decision to liquidate is effectively exogenous. 
...
Table \ref{tab:spread_table} summarizes the main determinants of credit spreads for asset-based, CF-based debt contracts and the pooled sample. Credit spreads are calculated as the difference between interest rates and the treasury rate at the corresponding maturity. To ensure that the observed spread reflects the original terms of the debt contract, I only consider the time of issuance. All three specifications include period fixed effects, sector and credit rating dummies, the logarithm of firm age and employment as well as the share of CF-based debt relative to total debt.\footnote{Section \ref{sec:credit spreads} of the appendix discusses these factors in more detail and table \ref{tab:spread_table_full} in the appendix presents the full regression output. To test the robustness of my results, I repeat these analyses using interest rates as the dependent variable and at a firm-level, using average credit spread as the dependent variable. These results are reported in \ref{sec:robustness}.}
...
\noindent Structural models of asset-based and CF-based debt financing typically consider credit market frictions as either asset-based or earings-based limits to borrowing. In contrast, table \ref{tab:spread_table} shows that greater asset value and cash flows correlate with lower spreads for both loan-types. This indicates that size and profitability are important determinants of credit frictions irrespective of the form of borrowing. Another important determinant of credit spreads is leverage, which has a large, positive effect on credit spreads for both loan-types. Firm age has a significant, negative effect on credit spreads, suggesting that strong creditor-debtor relationships can help reduce the cost of external finance. 

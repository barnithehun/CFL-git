...
Borrowing against future cash flows could relax the collateral constraints of small but productive firms that operate under efficient scale. However, this form of borrowing remains disproportionately expensive for small firms. I argue that his premium reflects small firms' tendency to liquidate under financial distress. Given the loss of future cash flows upon liquidation, lenders must compensate for liquidation risk by imposing higher spreads on cash flow-based debt. This puts small and medium-sized firms at a disadvantage since high reorganization costs often force the liquidation of these businesses. I study the general equilibrium effects of this mechanism in a heterogeneous firms model, calibrated to the U.S. economy. The high cost of cash flow-based debt experienced by small firms suppresses entry and yields significant aggregate productivity losses. This result suggests that recent policy efforts to streamline the reorganization process, such as the Small Business Reorganization Act of 2019, can raise aggregate productivity, by improving small firms' access to external finance. 
...
Borrowing constraints defined by the value of firms' collateralizable assets create a self-perpetuating cycle: insufficient collateral limits access to external finance, which in turn limits growth and delays the accumulation of collateral. Accordingly, collateral constraints are often highlighted as major barriers to firm growth (Beck et al., 2006; Schmalz et al., 2017) and as key sources of credit misallocation and aggregate productivity losses (Catherine et al., 2021). Borrowing against future cash flows (CF-based debt) could, in principle, relax these constraints for small but productive firms, since this form of borrowing evaluates expected future earnings rather than the accumulated collateral (Lian and  Ma, 2021). However, for most firms, CF-based borrowing remains significantly more expensive than borrowing against assets (asset-based debt) - see Panel A of \hyperref[tab:motivation]{{Table~\ref*{tab:motivation}}}. The premium on CF-based debt may be detrimental to the broader economy, as it suppresses the growth of asset-poor but productive firms that could contribute most to aggregate output in the absence of credit market frictions.

In this paper, I argue that a key factor contributing to the high cost of CF-based debt is the elevated liquidation risk associated with small and medium-sized firms. Smaller firms are significantly more likely to liquidate under financial distress than large enterprises, which reflects the administrative and time expenses of the reorganization process (Antill and Grenadier, 2019; Corbae and D'Erasmo, 2021) - see Panel B of \hyperref[tab:motivation]{{Table~\ref*{tab:motivation}}}. Given the loss of future cash flows upon liquidation, lenders must compensate for the elevated liquidation risk by imposing higher spreads on cash flow-based debt.\footnote{Lenders typically cannot overturn borrowers' liquidation decisions. I discuss this point further in section \ref{sec:emp liqprob}.} Hence, creditor perceptions of liquidation risk limit the ability of asset-poor but productive firms to pledge future cash flows as collateral. I study the broader macroeconomic implications of this mechanism in a heterogeneous firms model, calibrated to the U.S. economy. I ask: to what extent do reorganization costs raise liquidation risk, limit access to CF-based debt, and contribute to aggregate productivity losses?
...
To answer these questions, I develop a structural model that quantifies the general equilibrium effects of reorganization costs on liquidation probability and access to debt finance, along with macroeconomic consequences such as capital misallocation and aggregate productivity. This exercise demands a rich model framework that incorporates in-equilibrium defaults and firm-specific external finance premia (Khan, Senga, and Thomas, 2017), bankruptcy resolution decisions (Tamayo, 2017; Antill and Grenadier, 2019; Corbae and D'Erasmo, 2021), and heterogeneity of debt contracts (Lian and Ma, 2021; Drechsel, 2023; Gonzalez and Sy, 2024). To the best of my knowledge, this is the first model framework that studies the macroeconomic effects of the credit market frictions associated with asset-based and CF-based debt financing in the presence of in-equilibrium defaults and heterogeneous bankruptcy resolution decisions. 

In the model, firms finance their investments by net wealth and borrowing against assets or future cash flows. A positive share of firms experience financial distress in equilibrium, which leads to liquidation or reorganization, mirroring Chapter 7 and Chapter 11 of the U.S. bankruptcy code. Reorganization allows firms to continue operating but incurs fixed costs, which introduces economies of scale into bankruptcy resolution: large firms typically reorganize while smaller firms often liquidate. The lender sets firm-specific interest rates based on default risk. For cash flow-based debt, the lack of physical collateral increases the lender's potential losses if the borrower is liquidated under financial distress. The lender cannot reverse borrowers’ liquidation decisions, therefore it must treat liquidation as an exogenous risk. As a result, small but productive firms that are expected to liquidate in default due to their size must pay higher spreads on CF-based debt to offset the elevated liquidation risk. This mechanism perpetuates credit misallocation, suppresses firm entry, and ultimately leads to a loss of aggregate productivity.
...
In a broader context, this paper contributes to the literature on the macroeconomic consequences of credit market frictions in heterogeneous firm models (Khan and Thomas, 2013; Khan, Senga, and Thomas, 2017; Ottonello and Winberry, 2020; Kochen, 2022). Another strand of the literature allows for heterogeneity of debt contracts (secured and unsecured) in representative firm models (Azaridis, Kaas, and Wen, 2015; Luk and Zheng, 2022). This paper bridges these complementary lines of research by studying how the interaction between heterogeneous loan types and firms shapes the macroeconomic impact of credit market frictions.

The paper also offers insights into SME financing. A substantial body of research highlights the role of institutional factors, such as the protection of creditor rights, court enforceability, and the efficiency of the legal system as key determinants of SMEs' financing environment (Beck et al., 2006; OECD, 2006; Rao et al., 2022). This is reinforced by evidence that `country effects' play a significant role in determining the severity of the financial constraints SMEs face (Beck and Demirguc-Kunt, 2006). I add to this discussion by emphasizing that bankruptcy frameworks that facilitate and incentivize the reorganization of small firms alleviate borrowing constraints for SMEs, by improving their access to CF-based debt. 
...
This section documents two key facts about bankruptcy resolution decisions among U.S. firms that motivate the model assumptions. First, the likelihood of liquidation decreases with firm size (measured by total assets), and fixed reorganization costs largely explain this pattern. Second, lenders have limited ability to prevent borrowers from choosing liquidation. Then, I turn to a brief discussion of the main factors influencing credit spreads on asset-based and cash flow-based debt.

\subsection{Reorganization Costs and Liquidation Probability \label{sec:emp liqprob}} 

I study bankruptcy resolution decisions using the Federal Judicial Center's Integrated Database (IDB), which contains a total of 160,367 Chapter 7 and Chapter 11 bankruptcy filings between 2010 and 2023. Panel A of Figure \ref{chart:liqprob_emp} documents all Chapter 7 (liquidation) and Chapter 11 (reorganization) filings across firm sizes (measured by total assets) and Panel B presents the share pf Chapter 7 resolutions to all bankruptcies.   \vspace{3mm} \\
\textit{The share of firms liquidating under financial distress declines with firm size.} \\ 
Similar trend has been documented before on various datasets by Bris et al. (2006), Yu and He (2018), and Corbae and D'Erasmo (2021). Resolving default via reorganization often entails lengthy negotiations between debtors, creditors, and courts, which imposes large time costs as well as administrative and legal expenses on the affected parties. Evidence suggests that a significant share of these costs is independent of firm size. For instance, LoPucki and Doherty (2004, 2011) find that professional fees associated with reorganization as a percentage of assets decrease with firm size. Bris et al. (2006) finds a similar trend for the total costs of reorganization. The declining probability of liquidation can be attributed to these costs, as small and medium-sized enterprises often lack the resources to cover these expenses. Consistent with these observations, Antill and Grenadier (2018) and Corbae and D'Erasmo (2021) replicate the decreasing liquidation probability in structural models by incorporating large \textit{fixed costs} of reorganization.
...
Under the US bankruptcy framework, the debtor is expected to file for bankruptcy - although creditors may petition the court to initiate bankruptcy proceedings against the debtor, this is not the norm. The IDB dataset documents both the original chapter under which bankruptcy was filed and the chapter under which it was ultimately resolved. In the case of Chapter 11 (reorganization) filings, 6.5\% were eventually converted to Chapter 7 (liquidation). In contrast, only 0.16\% of Chapter 7 filings were later converted to Chapter 11, reflecting the legal, and practical difficulties in overturning a liquidation decision. Although 11 U.S.C. § 706(b) allows the creditor to request a conversion from Chapter 7 to Chapter 11, if the firms' management is unwilling to continue the court is unlikely to grant the conversion of the case. Moreover, it is unlikely that the lender can replace the original management without a significant loss of value. This evidence suggests that, from the lender's perspective, the decision to liquidate is effectively exogenous.
...
\noindent Structural models of asset-based and CF-based debt financing typically consider credit market frictions as either asset-based or earings-based limits to borrowing. In contrast, table \ref{tab:spread_table} shows that greater asset value and cash flows correlate with lower spreads for both loan-types. This indicates that size and profitability are important determinants of credit frictions irrespective of the form of borrowing. Another important determinant of credit spreads is leverage, which has a large, positive effect on credit spreads for both loan-types. In line with Kochen (2022), firm age has a significant, negative effect on credit spreads.
...
Defaults can be resolved through liquidation or reorganization. In the case of liquidation, the firm exits, and all its undepreciated capital stock is resold at a discounted value, $\phi_l(1-\delta)k$, where $\phi_l \in (0,1)$. The rest of the stock cannot be recovered, which indicates that corporate assets are often highly specialized and illiquid which limits their value for second-hand users (Kermani and Ma, 2020). The proceeds from selling the capital stock are distributed between the lender and the household - who owns the firm. The exact allocation depends on the debt contract in place, this is further discussed in following section. 

Reorganization allows the firm to continue, but incurs a variable cost $\phi_r V_{cont}(x,\varepsilon)$, and a fixed cost $\zeta_r$, borne entirely by the household.\footnote{The incidence of these costs has a minimal effect on credit market frictions. Lenders' expenses raise the external finance premium directly, whereas households' costs limit access to external finance indirectly by raising liquidation risk.} This fixed cost is crucial in replicating the decreasing liquidation probability across firm sizes - I discuss the sources of these costs in more detail in section \ref{sec:emp liqprob}. Additionally, the lender extracts a payment $\Pi_r(a,\varepsilon)$ from the household (the firm's owner), who has an incentive to keep the firm running. This transfer is the outcome of the debt renegotiation process and its exact value depends on the debt contract in place - further discussed in the following section.\footnote{Corbae and D'Erasmo also model the reorganization process as a lump-sum transfer between the lender and the borrower. However, their approach is richer, as they model the Nash Bargaining process that determines the value of the transfer.} 

To keep the model parsimonious, I assume that the default resolution is handled by an external planner (bankruptcy courts) who maximizes the total value retained after bankruptcy, without considering how payoffs are distributed between the lender and the household.\footnote{Taking the liquidation decision out of firms' or households' hands keeps the computational burden manageable. In the US context, this assumption serves only that purpose. In other legal systems such as Spain, the court supervise the bankruptcy process, validating reorganization plans or a initiating liquidation. Hence, in a broader context, this description of the default resolution process is more realistic.} Hence, the default resolution decision can be summarized as: 
...
\textit{ 1.) The recovery of asset-based debt when the firm undergoes liquidation}. Since the debt contract is backed by physical assets, the lender can recover the entire liquidation value of the firm, $\phi_l(1-\delta)k$. This corresponds to in-default payoffs in `standard' models of credit frictions, that assume asset-based borrowing constraints. \vspace{3mm} \\
\textit{ 2.) The recovery of asset-based debt when the firm undergoes reorganization}. When the borrower undergoes reorganization secured lenders are protected by the ‘best interest of creditor’ test.\footnote{Established under 11 U.S.C. § 1129(a)(7) of the U.S. Bankruptcy Code.} This states that secured creditors cannot be worse off under the proposed reorganization plan than they would be under liquidation. Accordingly, I assume that in this case, the lender can retrieve the same $\phi_l(1-\delta)k$ during the renegotiation of the debt contract.\footnote{Theoretically, lenders could negotiate better payoffs under the reorganization process. However, it is unlikely that secured by physical assets, lenders would \textit{expect} higher payoffs from default than the liquidation value of the collateral. This reflects the high costs of monitoring borrowers expected future cash flows on an ongoing basis, which is not necessary when loans are backed by physical collateral. For simplicity, these costs are not featured in the model but are further discussed in section \ref{sec:fixed costs} of the appendix.} \vspace{3mm} \\
\textit{ 3.) The recovery of CF-based debt when the firm undergoes liquidation}. Since the debt is not backed by physical collateral, which makes the lender poorly equipped to recover the liquidation value. As a result, the lender can only recover a small fraction of the total liquidation value, $\kappa \phi_l(1-\delta)k$, where $\kappa$ is close to zero. In practice, a single lender could recover some value in liquidation even without collateral backing. However, most firms have multiple creditors: 78\% of the studied firms have more than one debt contract, and 53\% hold both asset-based and cash flow-based debt simultaneously. Even if a firm has no other lenders at the time of issuance, the creditor often cannot be sure that the firm will not take on a new, higher-priority debt later.\footnote{Negative-pledge covenants are commonly used, but Ivashina and Vallée (2025) argue that contractual loopholes often undermine their effectiveness in protecting creditors.} Hence, assuming low expected recovery rates for cash flow-based debt in liquidation is a close approximation for most debt contracts.\footnote{In line with this, Bris et al. (2006) report zero recovery for unsecured creditors in 95\% of Chapter 7 cases.}   \vspace{3mm} \\
\textit{ 4.) The recovery of CF-based debt if the firm undergoes reorganization}. The lender expects to recover a fraction of the firm’s continuation value through the renegotiation of the debt contract, realizing a payoff of $\phi_c V_{cont}(x,\varepsilon)$. Hence, the lender's expected payoff is determined by the continuation value of the firm.\footnote{For an analogous description in-default payoffs for CF-based debt, see Drechsel (2023).} In practice, the process of extracting may vary depending on the specifics of the debt contract. When the debt is secured against the entire corporate entity, the lender may gain access to the borrower's cash flows directly. When the debt is unsecured, higher continuation value of the firm allows the lender to negotiate better terms during reorganization. For a detailed description of this mechanism see Corbae and D'Erasmo (2021). \vspace{3mm} \\
...
\begin{equation}  \label{eq:P_reorg}
   \Pi_{r}(a,\varepsilon) = (1-\tau) \phi_l (1-\delta) k +\tau \phi_c V_{cont} (x, \varepsilon).
\end{equation}
...
\begin{figure}[H]  % [H] indicates placing the image here
    ...
    \includegraphics[width=1\textwidth]{C:/Users/szjud/OneDrive/Asztali gép/EBCs/CFL-git/Latex codes/Plots/Flow_end.png}
...
\textit{3.) Elimination of the Absolute Priority Rule}. Under Subchapter V, firm owners may retain equity even if unsecured creditors are not fully repaid. This increases the feasibility of restructuring for firms with limited collateral. \vspace{3mm} \\
...
The significant time and administrative burden of reorganization raises the likelihood of liquidation for small firms, increasing the cost of cash flow-based debt and reinforcing the effects collateral constraints. To quantify the macroeconomic impact of this dynamic, I develop a general equilibrium model with heterogeneous firms, in-equilibrium default, endogenous resolution choices (liquidation vs. reorganization), and heterogeneous debt contracts (asset-based and cash flow-based). Then, I use the calibrated model to evaluate a policy reform that cuts reorganization costs in half. The reform reduces average liquidation risk, improves small firms’ access to cash flow-based financing, and increases the mass of active firms. The combination of these changes raises aggregate productivity by 1.4\%. The gains are largest for small, but high-productivity (young) firms, while larger firms are less affected.

The baseline results suggest that bankruptcy reforms, such as the Small Business Reorganization Act (SBRA) of 2019 may also have a significant effect on debt finance. By reducing reorganization costs, policymakers can improve credit allocation, alleviate financing constraints and ultimately improve aggregate productivity. Targeted policies that facilitate the reorganization of small firms have similar effects to universal programs that apply to every borrower. However, limiting creditor rights over the reorganization process may have unintended consequences, as poorer bargaining position leads lenders to limit CF-based lending preemptively. These results highlight the importance of designing bankruptcy frameworks that promote debtors' flexibility to resolve bankruptcy by reorganization, without compromising creditor protection.
...
\bibitem{banerjee2010} Banerjee, A. V., \& Moll, B. (2010). Why does misallocation persist? \textit{American Economic Journal: Macroeconomics}, \textbf{2}(1), 189-206.
...
\bibitem{buera2011} Buera, F. J., Kaboski, J. P., \& Shin, Y. (2011). Finance and development: A tale of two sectors. \textit{American Economic Review}, \textbf{101}(5), 1964-2002.
...
\bibitem{midrigan2014} Midrigan, V., \& Xu, D. Y. (2014). Finance and misallocation: Evidence from plant-level data. \textit{American Economic Review}, \textbf{104}(2), 422-458.

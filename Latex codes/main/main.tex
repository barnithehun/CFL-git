...
\hline
Case &$\chi_0 $ - insolvency & $\chi_1, \ \chi_1^D$ - liquidation  & $\chi_2$ - CF based &  Outcome  \\ \hline
1. & $\chi_0 = 0 $ &  $\chi_1 = 0$ & $\chi_2 = \{0,1\} $ & Repays debt, Continues \\
2. & $\chi_0 = 0$ &  $\chi_1 = 1 $ & $\chi_2 =  \{0,1\}$ & Repays debt, Liquidated   \\
3. & $\chi_0 = 1$ &  $\chi_1^D = \{0,1\}$ & $\chi_2 = 0$ & Insolvent, Liquidated  \\
4. & $\chi_0 = 1$ &  $\chi_1^D = 0$ & $\chi_2 = 1$ & Insolvent, Reorganized  \\
5. & $\chi_0 = 1$ &  $\chi_1^D = 1$ & $\chi_2 = 1$ & Insolvent, Liquidated \\ 
\hline
\end{tabular}
} % End of \resizebox

...
\newpage
\subsection*{Summary notes - 10.04}
\begin{itemize}
    \item A more elegant way to solve exogenous defaults is to set up a productivity process that may teleport firms to the lowest productivity. This would not generate incentives to get rid of all cash on hand, since firms could still choose to exit. Another benefit is that you have to change just the productivity process.

...
In a broader context, this paper contributes to the literature on the macroeconomic consequences of credit market frictions in heterogeneous firm models (Khan and Thomas, 2013; Khan, Senga, and Thomas, 2017; Ottonello and Winberry, 2020; Kochen, 2022). Another strand of the literature focus on heterogeneity in debt contracts (i.e., secured and unsecured) lending in representative firm models (Azaridis, Kaas, and Wen, 2015; Luk and Zheng, 2022). This paper bridges these complementary lines of research by studying how the interaction between heterogeneous loan types and firms shapes the macroeconomic impact of credit market frictions.

...
\title{\Large{\textbf{Going Public over the Business Cycle}\thanks{
I am deeply indebted to Lidia Cruces, Georg Duernecker, Johannes G\"onsch, Marek Ignaszak, Leo Kaas, Alexander Ludwig, and Nicolò Russo for their invaluable guidance and support. I also extend my thanks to Husnu C. Dalgic for an insightful discussion, and to the audiences at FQMG brown bag seminar, Spanish Macroeconomics Network, and Frankfurt-Mannheim Macro Workshop for their comments and suggestions.}}}
\author{Jisu Jeun
\thanks{Goethe University Frankfurt. Theodor-W.-Adorno-Platz 3, 60323 Frankfurt am Main, Germany. Email: \url{jeun@wiwi.uni-frankfurt.de}{}; Website: \url{jisu-jeun.squarespace.com}{}}\\
\vspace{-0.4cm}
% \emph{Goethe University Frankfurt}\\
\vspace{0.5cm}
\textbf{Job Market Paper}\\
\vspace{-0.3cm}
\date{\today
\vspace{0.15cm}
\href{http://jisujeun.github.io/jisujeun/JMP_JisuJeun.pdf}{[Click here for the latest version]}}
}

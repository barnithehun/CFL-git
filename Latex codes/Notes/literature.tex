...
\subsection*{Hartman-Glaser et al. (2025)}
They argue that lenders are necessary to finance the reorganization of firms. Firms are only able to raise equity periodically. When they get in to financial distress due to a negative cash flow shock they need the lender to bridge the period of distress by providing financing until the next round of equity raising. If the financing capacity is CF-based (going concern value exceeds the liquidation value) the lender is willing to do this. If the financing capacity is asset-based the lender always liquidates the firms. Hence, they type of lending capacity affects the outcome of bankruptcy resolution and vice versa. \textit{However, the underlying reason is the same, i.e. the  going concern value exceeds or the liquidation value, therefore they do not really boost each other. Both simply seem to be the reflection of the same circumstances.} \vspace{3mm} \\
Their model deterministically ties asset-based lending to liquidation and CF-based lending to reorganization. Lenders provide bridge financing that is necessary for reorganization, meaning that they can enforce liquidation even if the firm would reorganize. They do not account for reorganization costs or productivity shocks (there are only cash flow shocks). Hence, if a firm borrows against cash flows its going concern value is higher than the liquidation value, hence it will be worth reorganizing. Moreover the lender takes full control of the firm in bankruptcy meaning that any conflict of interest assumed away. Cases where the liquidation happens under CF-based debt are not possible by assumption. \vspace{3mm} \\
I do not tie CF-based lending to reorganization deterministically. The lender has limited control over the bankruptcy resolution process as it cannot take over the firm when it goes into bankruptcy. Hence, it might happen that the outcome of the default resolution is not optimal for the lender (due to reorganization costs). Firms may file for liquidation even if the debt contract is backed by future cash flows. Once the borrower filed chapter 7, there is not much the lender could do to turn this decision around. Moreover, if the financing capacity is CF-based the lender recovers very little of the debt upon liquidation, which gives the main mechanism of my model. Hence, my model emphasizes the role of ex-ante risk of liquidation in financial distress, which by assumption cannot happen in their model. 
...
\newpage
\section*{Abstract free-thinking}

Other paper: 
\begin{itemize}
    \item Entry sentence: a lot of paper summarizes what it does in a single sentence, and then elaborates. Consider doing this. Alternatively, I could start with introducing CF-based and asset-based lending. 
    \item You need to have the main ingredients of the paper 
    \begin{itemize}
        \item I study the the macroeconomic implications.. 
        \item AB - CF debt
        \item Liquidation reorganization, reorganization costs and how these affects small firms 
        \item How liquidation probability affects access to CF-based debt 
    \end{itemize}
\end{itemize}


My Abstract: 
 - I document that asset-poor firms often borrow against expected future cash flows rather than the liquidation value of physical assets, but pay significantly higher spreads on these debt contracts than large firms. 
 - I attribute this to the high ex-ante liquidation probability of small firms.
 - Corporate debt contracts often focus on the going concern . In this paper, I argue that low ex-ante liquidation probability limit small firms ability to exploit this form of borrowing.

 Borrowing against future cash flows rather than the liquidation value of assets, represents an opportunity for asset-poor firms to escape collateral constraints. Yet, these firms pay significantly higher spreads these debt contracts . In this paper, I argue that  

\newpage

\noindent \textbf{Abstract 1} \\
This paper studies asset-based and cash flow-based lending in a heterogeneous firms model, where bankrupt firms may decide between liquidation or reorganization. The model highlights that creditors impose stricter terms on cash flow-based debt contracts if they believe that the borrower is likely to liquidate under financial distress. This puts small firms at a disadvantage. Their access to cash flow-based debt is limited by high liquidation risk, whereas their access to asset-based debt is constrained by a lack of pledgeable assets. The resulting misallocation of capital leads to a significant loss in aggregate productivity. However, this could be reduced by facilitating reorganizations. Reducing reorganization costs to a quarter would increase aggregate productivity by 2.4\% by improving access to cash flow-based debt. \vspace{3mm} \\
\textbf{Abstract 2} \\
I develop a general equilibrium model featuring heterogeneous firms and endogenous liquidation risk, that links the high cost of cash flow-based debt levied on small firms to their tendency to liquidate under financial distress. Given the loss of future cash flows upon liquidation, lenders must compensate for liquidation risk by imposing higher spreads on cash flow-based debt. This puts small and medium-sized firms at a disadvantage since high reorganization costs often force the liquidation of these businesses. To quantify the broader
macroeconomic effects of this mechanism, I calibrate the model to the U.S. economy and consider an exogenous reduction in reorganization costs. This shock reduces the ex-ante liquidation risk associated with small firms, allowing them borrow against future cash flows at a lower cost. The resulting improvement in capital allocation and firm entry significantly raises aggregate productivity. Moreover, the model shows that size-based reorganization reforms, such as the Small Business Reorganization Act, can meaningfully raise aggregate productivity by improving small firms’ access to external finance. \vspace{3mm} \\
\textbf{Abstract 3} \\
...
\textbf{Abstract 4} \\
This paper argues that borrowing against future cash flows is particularly costly for small and asset-poor firms due to high reorganization costs. I develop a general equilibrium model of heterogeneous firms, endogenous default defaults and bankruptcy resolution reflecting chapter 7 (liquidation) and chapter 11 (reorganization) of the U.S. bankruptcy code. The competitive lender associates high ex-ante liquidation risk to small and medium sized firms since high reorganization costs often force the liquidation of these businesses. Since liquidation wipes out all future cash flows, the lender must impose higher spreads on smaller firms to compensate for liquidation risk. To quantify the broader macroeconomic effects of this dynamic, I calibrate the model to the U.S. economy and consider a reduction in reorganization costs. This reduces ex-ante liquidation risk associated with small firms, allowing them borrow against future cash flows at a lower cost. The relaxation of credit constraints improves the allocation of capital across firms which, together with higher firm entry, significantly increases aggregate productivity. These results underline the benefits of a reorganization-friendly bankruptcy regime. Size-based reforms, such as the U.S. Small Business Reorganization Act of 2019, can significantly raise aggregate productivity by improving small firms’ access to external finance. Since liquidation wipes out all future cash flows, the lender must impose higher spreads on smaller firms compensate liquidation risk. 

\textbf{Abstract 5} \\
This paper studies how reorganization costs limit access to cash flow-backed borrowing, distort firm financing and reduce aggregate productivity. I develop a general equilibrium model with heterogeneous firms, endogenous default, and bankruptcy outcomes reflecting Chapter 7 (liquidation) and Chapter 11 (reorganization) of the U.S. bankruptcy code. Firms may borrow against physical assets or expected future cash flows. Since liquidation wipes out all future cash flows, lenders impose higher spreads on cash flow-based debt contracts to compensate for liquidation risk. This puts small and medium-sized firms at a disadvantage since high reorganization costs often force the liquidation of these businesses. Calibrated to U.S. firm-level data, the model shows that lowering reorganization costs reduces ex-ante liquidation risk, narrows the financing gap between small and large firms, and raises aggregate productivity by reallocating capital and promoting firm entry. These results underline the benefits of a reorganization-friendly bankruptcy regime. Size-based reforms, such as the U.S. Small Business Reorganization Act of 2019, can significantly raise aggregate productivity by improving small firms’ access to external finance. This paper examines how high reorganization costs constrain asset-poor firms’ access to external finance and reduce aggregate productivity. \vspace{3mm} \\


\textbf{Abstract 6} \\
This paper argues that high reorganization costs limit access to cash flow-backed borrowing, distort firm financing and depress aggregate productivity. I develop a general equilibrium model with heterogeneous firms, endogenous default, and bankruptcy outcomes reflecting Chapter 7 (liquidation) and Chapter 11 (reorganization) of the U.S. bankruptcy code. Firms may borrow backed by physical assets or expected future cash flows. Due to high reorganization costs, smaller firms are at an elevated risk of liquidation, which prevents them from credibly pledging future earnings as collateral. Consequently, asset-poor firms are constrained by insufficient physical collateral on the one hand and elevated liquidation risk on the other. Calibrated to U.S. firm-level data, the model shows that lowering reorganization costs reduces ex-ante liquidation risk, narrows the financing gap between small and large firms, and raises aggregate productivity by reallocating capital and promoting firm entry. These results highlight the benefits of a reorganization-friendly bankruptcy regime. Size-based reforms, such as the 2019 Small Business Reorganization Act, can generate substantial macroeconomic gains by improving small firms’ access to external finance.


List of Titles: 
\begin{itemize}
    \item Reorganization Costs and Credit Frictions
    \item Reorganizing Corporate Debt Finance
    \item The Macroeconomic Consequences of Reorganization Costs
\end{itemize}

...
function parameters()
    ...
    nu::Float64 = 2/3 * DRS
    pc::Float64 =   30.827238257263218
    beta::Float64 = 0.96
    delta::Float64 = 0.1
    pdef_exo_l::Float64 =  0.01917533484188137
...
@elapsed SumPol0, e_chain0, Fmat0 = FirmOptim(wage, 0, zeta_Rl)
...
c_e, f0 = EntryValue(SumPol, e_chain)
results_baseline = sumSSsme(SumPol,Fmat,f0)
c_e_baseline = c_e

@elapsed wage_alt = find_zero(wage -> FindWage(wage, 0, zeta_Rl) - c_e_baseline, (0.97, 1.1), Bisection(), rtol=tolerance, verbose=true)
SumPol, e_chain, Fmat = FirmOptim(wage_alt, 0, zeta_Rl)
c_e, f0 = EntryValue(SumPol, e_chain)


# results_0 = sumSSsme(SumPol,Fmat,f0)

# results_1to3 = sumSSsme(SumPol,Fmat,f0)

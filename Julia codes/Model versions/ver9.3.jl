...
######### Endogeneous default decisions, zero value in default ############
###########################################################################
...
function FirmOptim(wage; phi_c)
    ...
    while !isequal(kbexq_old,kbexq_new)
        ...
        for s_i in 1:n
            ...
            # the problem is that this is current value not the future value given default and policies
            val = Values[s_i]

########################################################################
############# VER 5 - adding endogneous default to VER 4 ###############
########################################################################
...
@elapsed for new_a_i in 1:m   
     ...
     for s_i in 1:n
            ...
            pdef = min(pdef_exo + pdef_endo[s_i], 1)
...
for s_i in 1:n
    ...
    for next_e_i in 1:e_size
        ...
        exit = a_vals[policies[xe_index],3]
        
        # update endogeneous default probability
        pdef_endo[s_i] = pdef_endo[s_i] + p_trans*exit
...
# this way it does not show already exited firms becasue they are of 0
...
plot(plot1, plot3, plot5, plot2, plot4, plot6, plot7, plot8, plot9, layout = (3, 3), size = (1200, 800))

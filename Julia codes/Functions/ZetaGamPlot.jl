...
xe_i_1 = x_i + (e_i-4)*x_size   
xe_i_2 = x_i + (e_i-5)*x_size   
xe_i_3 = x_i + (e_i-6)*x_size   
...
p4 = plot(zeta_R_vec ./ 1000, SumPolZeta[xe_i_1, 18, :] ./ SumPolZeta[xe_i_1, 18, 1], 
    title="Firm Value", titlefont=font(14), xlabel="Zeta_R (thousands)", ylabel="FirmValue", 
    legend=:bottomright, linecolor=:blue, linewidth=2, label="Prod = $e_val_1")

# Add xe_i_2 and xe_i_3 series to p4
plot!(zeta_R_vec ./ 1000, SumPolZeta[xe_i_2, 18, :] ./ SumPolZeta[xe_i_2, 18, 1], linecolor=:red, linewidth=2, label="Prod = $e_val_2")
plot!(zeta_R_vec ./ 1000, SumPolZeta[xe_i_3, 18, :] ./ SumPolZeta[xe_i_3, 18, 1], linecolor=:green, linewidth=2, label="Prod = $e_val_3")

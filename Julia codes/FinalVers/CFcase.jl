...
function parameters()
    ...
    nu::Float64 = 2/3 * DRS
    # pc::Float64 = 27.839620 # adjusting phi_c 
     pc::Float64 =  40.250295276496985
    # pc::Float64 = 40.627712 # adjusting phi_c_hh
    beta::Float64 = 0.96
    delta::Float64 = 0.1
    # pdef_exo_l::Float64 = 0.015058 # adjusting phi_c 
    pdef_exo_l::Float64 =  0.018990861085178175
    # pdef_exo_l::Float64 = 0.013670   # adjusting phi_c_hh 
    ...
    zeta_L::Float64 = 0
    # phi_c_hh::Float64 =  0.6210 # adjusting phi_c_hh 
    phi_c_hh::Float64 = 0.7960 # baseline
    Fcut::Float64 = 1200
...
# calibration values
wage = 1;
# phi_c = 0.65  # adjusting phi_c
phi_c = 0.2810 # baseline

# zeta_Rl = 2590  # baseline
zeta_Rl = 2874.9672229430475
...
zeta_Rl = 1435
# zeta_Rl = 860 # baseline
@elapsed SumPol0, e_chain0, Fmat0 = FirmOptim(1.023974609374, phi_c, zeta_Rl)
...
p1, p2 = DebtScedule(SumPol0, 25, 17; phi_c = phi_c)
p3, p4 = DebtScedule(SumPol0, 25, 20; phi_c = phi_c)
p5, p6 = DebtScedule(SumPol0, 25, 22; phi_c = phi_c)
...
plotPol(SumPol0, SumPol, e_size-7)
...
options = Optim.Options(
    ...
    store_trace = true,
    show_every = 1)
@elapsed CalRes = optimize(ErrorFunc_CF, initvec, NelderMead(), options)

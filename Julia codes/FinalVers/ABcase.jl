...
function parameters()
    ...
    nu::Float64 = 2/3 * DRS
    pc::Float64 =  42.85416330625629
    beta::Float64 = 0.96
    delta::Float64 = 0.1
    pdef_exo_l::Float64 = 0.015463039331682709
...
initvec = [ 41.891522950040226,  0.015765125957071673, 2946.7519489034066]
options = Optim.Options(
    ...
    store_trace = true,
    show_every = 1)
@elapsed CalRes = optimize(ErrorFunc_AB, initvec, NelderMead(), options)

println(CalRes)


# CFshare_calib = CalRes.minimizer
ABrel_calib = CalRes.minimizer
